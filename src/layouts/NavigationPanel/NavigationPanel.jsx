...
function NavigationPanel({ children }) {
	...
	return (
		<div className='navigation-panel'>
			<div className='navigation-panel__inner'>
				<a className='navigation-panel__logo' href="#" target="_blank" rel="noopener noreferrer">
					{/* <img className='navigation-panel__logo-img' src="bookmark-logo.svg" alt="Логотип" /> */}
					<svg className='navigation-panel__logo-img' xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
				...
				<div className='navigation-panel__menu'>
					<ul className='navigation-panel__menu-list'>
						{children}
					</ul>
				</div>
			</div>
